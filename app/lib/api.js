...
export const api = {
  ...
  getFilmographyPath: function(id) {
  ...
  getCategoryPath: function(id, page = '1') {
  ...
  getNowPlayingPath: function(page = '1') {
  ...
  getComingSoonPath: function(page = '1') {
  ...
  getRecommendationsPath: function(id, page = '1') {
